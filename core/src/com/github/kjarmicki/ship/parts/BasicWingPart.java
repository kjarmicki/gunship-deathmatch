...
public class BasicWingPart extends GenericPart implements WingPart {
    ...
    public static WingPart getLeftVariant() {
        return new BasicWingPart(LEFT_VARIANT);
    }

    public static WingPart getRightVariant() {
        return new BasicWingPart(RIGHT_VARIANT);
    }
    ...
    private BasicWingPart(WingVariant variant) {
    ...
    public Part duplicate() {
        BasicWingPart duplicate = new BasicWingPart(variant);
